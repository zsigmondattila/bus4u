...
function sendSchedule(){
  ...
  axios.delete('https://bus4u.fast-table.com/v1/admin/delete_timetables_from_route', { params: {route_uid: mainForm.route.route_uid, station_uid: mainForm.station.station_uid }})
    .then(() => {
      timetable.value.forEach(async(schedule) => {
        ...
        await axios.post('https://bus4u.fast-table.com/v1/admin/add_timetable_to_route', data)
        mainForm.route = null
        mainForm.station = null
      })
...
function getTimetable() {
  axios.get('https://bus4u.fast-table.com/v1/get_departure_times_for_station_in_route', { params: {route_uid: mainForm.route.route_uid, station_uid: mainForm.station.station_uid }})
  .then(rsp => {
    if(rsp.status == 200) {
      timetable.value = []

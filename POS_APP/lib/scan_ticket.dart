...
class _ScanTicketState extends State<ScanTicket> {
  ...
  Future<void> sendscannedTicket(String ticketUid) async {
    ...
    if (response.statusCode == 202) {
      showStatusMessage('Ticket successfully validated. Have a nice trip!', 202);
    } else if (response.statusCode == 422) {
      showStatusMessage(
          'The scanned ticket is invalid or expired. If you think this happened by mistake, please contact the driver.', 422);
    } else {
  ...
  if (statusCode == 202) {
    ...
    textColor = const Color.fromARGB(255, 0, 0, 0); // Szövegszín a háttérszínhez illesztve
  }

...
async function onSubmit(e) {
  ...
  axios.get('http://192.168.139.208:3000/v1/get_available_tickets',
...
async function getStartStation(city){
  if(!city) return
  axios.get('http://192.168.139.208:3000/v1/get_stations_by_city', { params: { city_uid: city.city_uid }})
    .then(rsp => {
...
axios.get('http://192.168.139.208:3000/v1/get_cities')
  .then((rsp) => {

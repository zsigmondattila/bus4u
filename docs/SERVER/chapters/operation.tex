...
\begin{figure}[H]
    ...
    \caption{Felhasználó megvásárolt jegyei}
    \label{fig:ticket-list}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/departuretimes.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/adminstops.png}
    \caption{Megállók létrehozása/törlése}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/adminschedule.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/adminbuses.png}
    \caption{Buszok és alkalmazottak kezelése}
    \label{fig:buses-employees}
\end{figure}
...
követni a busz helyzetét. Legalul egy
Ticket scanner gomb fedezhető fel,

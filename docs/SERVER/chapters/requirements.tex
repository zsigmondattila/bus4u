...
\begin{itemize}
    \item \textbf{Programozási nyelvek}: Ruby, Dart, HTML, CSS, JavaScript
    \item \textbf{Keretrendszerek}: Ruby on Rails, Flutter, Vue.js
    \item \textbf{IDE}: Visual Studio Code
    \item \textbf{Verziókövetés}: Git és GitHub
    \item \textbf{Adatbázis}: PostgreSQL
    \item \textbf{Cloud szolgáltatás}: Azure
    \item \textbf{Webhoszt}: Netlify
    \item \textbf{Csoportos kommunikáció}: Slack
\end{itemize}
...
\begin{itemize}
    \item \textbf{Chrome}: 87 vagy újabb
    \item \textbf{Firefox}: 78 vagy újabb
    \item \textbf{Safari}: 14 vagy újabb
    \item \textbf{Edge}: 88 vagy újabb
\end{itemize}
...
\begin{itemize}
    \item \textbf{Operációs rendszer}: Android 5.0 vagy iOS 8.0 és újabb
    \item \textbf{Szabad tárhely}: minimum 120 MB
    \item \textbf{Memória}: 516–1024 MB
\end{itemize}
...
\begin{itemize}
    \item \textbf{Szabad tárhely}: legalább 100 MB
    \item \textbf{Memória}: minimum 510 MB
\end{itemize}

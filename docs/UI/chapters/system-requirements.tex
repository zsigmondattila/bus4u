A rendszer két fő részre bontható fel: háttérfolyamatok és megjelenítés. Mivel én a megjelenítés résszel foglalkozom, amely magában foglalja a felhasználói weboldalt, az adminisztrátori weboldalt és a mobilapplikációt, ezért a következőkben csak ezekre a részekre vonatkozó követelmények specifikációját fogom részletezni. A háttérfolyamatok követelményei a kollégám dolgozatában lesznek ismertetve \cite{bus4userver}.
...
\begin{itemize}
  \item A felület legyen logikusan felépítve, hogy felhasználó gyorsan és egyszerűen tudjon navigálni az oldalak között.
  ...
  \item A rendszernek reszponzívnak és hibatűrőnek kell lennie, azaz minden eszközön jól használhatónak kell lennie.
  \item A felhasználói felületnek egységesnek kell lennie, azaz minden platformon ugyanazok a színek és felületi elemek jelennek meg, hogy a felhasználók ne érezzék zavarónak az eszközök közötti váltást.
  \item Az ikonok és a gombok egyértelműen tükrözzék a funkciójukat, hogy a felhasználók könnyen megtalálják a keresett funkciókat.
  \item A felhasználói felületnek gyorsnak kell lennie, azaz a kérésekre azonnal válaszolnia kell, hogy a felhasználók ne érezzék lassúnak a rendszert.
\end{itemize}
...
\begin{itemize}
  ...
  \item A megvásárolt jegyek megtekinthetőek legyenek bejelentkezés után
  \item A jegyek QR-kódokkal legyenek ellátva a könnyebb beolvasás érdekében
\end{itemize}
...
\begin{itemize}
  \item A főoldalon statisztikák jelenjenek meg az eladott jegyek számáról, a megtett kilométerről és a bevételről, időintervallumok szerint csoportosítva
  \item A rendszer jelenítse meg a felületen a fontos emlékeztetőket és értesítéseket
  ...
  \item A járatokhoz lehessen csatolni és eltávolítani előre létrehozott megállókat
  \item A járatok indulási időpontjait jelenítse meg a rendszer, valamint kezelje ezek változtatásait és törlését
  ...
  \item A buszokhoz lehessen megadni útadó, biztosítás és műszaki vizsga lejárati időpontokat
  \item A buszokhoz hasonlóan lehessen kezelni az alkalmazotti fiókok listáját is, létrehozással, szerkesztéssel és törléssel
\end{itemize}

A rendszer funkcionalitását leíró használati eset diagramok a \ref{fig:use-case-user} és \ref{fig:use-case-admin} ábrákon láthatóak.

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/use-case-user.png}
  \caption{Use-case diagram a végfelhasználók lehetőségeiről}
  \label{fig:use-case-user}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/use-case-admin.png}
  \caption{Use-case diagram az adminisztrátorok lehetőségeiről}

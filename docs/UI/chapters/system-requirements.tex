...
\begin{itemize}
  ...
  \item A felhasználói felületnek reszponzívnak kell lennie, azaz minden eszközön jól használhatónak kell lennie.
...
cégek főnökei tudnak létrehozni, mindenik a saját busztársaságához. Itt regisztrációs lehetőség nincs, így meg lehet akadályozni az adminfelülethez való illetéktelen hozzáférést. A társult vállalatok főnökei a partnerség kezdetekor megkapják az admin jogú fiókjaikat. Az adminfelület funkciói oldalanként csoportosítva:

\begin{itemize}
  \item Főoldal: statisztikák az eladott jegyek számáról, a megtett kilométerről és a bevételről, időintervalumok szerint csoportosítva, emlékeztetők megjelenítése
  \item Megállók kezelése: megállók listázása, új megálló hozzáadása térkép segítségével, meglévő megállók szerkesztése, megállók törlése

...
A felhasználói követelmények azokat a funkciókat írják le, amelyre a felhasználó szemszögéből szükség van. A szoftver felületének általános követelményei a következők:
...
\begin{itemize}
  \item A főoldalon statisztikák jelenjenek meg az eladott jegyek számáról, a megtett kilométerről és a bevételről, időintervalumok szerint csoportosítva
  ...
  \item A járatok indulási időpontjait jelenítse meg a rendszer, ezek változtatásait és törlését pedig mentse el az adatbázisban
...
\begin{figure}[H]
  \centering
  \includegraphics[height=0.96\textheight]{figures/use-case.png}

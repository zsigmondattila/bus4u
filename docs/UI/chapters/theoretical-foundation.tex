...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.4\textwidth]{figures/moovit.jpg}}
...
\begin{figure}[h]
  \centering
  \frame{\includegraphics[width=0.4\textwidth]{figures/budapestgo.png}}
  \caption{

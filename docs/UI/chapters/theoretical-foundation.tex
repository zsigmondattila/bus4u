Már a 70-es években is felmerült az igény a buszok automatizált kezelésére, amely akkor a megállókban való torlódást szerette volna megoldani. Ekkor használták először a BFM\footnote{Bus Fleet Management - Busz Flotta Kezelés} kifejezést a buszok karbantartására. Később ezt a menetrendek kezelésére is alkalmazták, amely a buszok forgalmát és a járatok menetrendjét is magában foglalta. Napjainkban már ide tartozik a balesetmegelőzés, a buszok pozícióinak követése, az energiakezelés és a fenntarthatóság is. Ezt kibővítve az RTI\footnote{Real Time Information - Valós Idejű Információ} és az AVL\footnote{Automatic Vehicle Location - Automatikus Jármű Helyzet(követő)} rendszerekkel, egy olyan összetett busz kezelő rendszert kapunk, amely lehetővé teszi a buszok helyzeteinek valós idejű követését és az utasok számára a valós idejű információk megjelenítését, és amelynek együttes megnevezése a Dynamic Bus Fleet Management. \cite{orovsnjak2020bus}
